...
(function () {
  ...
  var S = {
    en: {
      ...
      // tutorial
      tut_1: 'Double-tap the glowing cell to place your first pup! Small zones are the best place to start.',
      tut_mark: 'This pup blocks its row, its column, its zone and every cell around it. Tap each glowing cell to mark ✕ — or swipe across them!',
      tut_marked: 'Nice marking!',
    ...
    zh: {
      ...
      tut_1: '双击发光的格子，放下第一只狗狗！从小区域入手最容易。',
      tut_mark: '这只狗狗占住了所在的行、列、区域，以及周围一圈格子。单击每个发光格子标上 ✕，也可以滑动连续标记！',
      tut_marked: '标记得真好！',
