...
(function () {
  ...
  var S = {
    en: {
      ...
      tut_mark: 'Nice! A pup rules out its row, column, yard and every cell touching it. Tap each glowing cell to mark ✕ — or drag across them!',
      tut_marked: 'Perfect crossing!',
    ...
    zh: {
      ...
      tut_mark: '真棒！一只狗狗会排除它所在的行、列、院子，以及紧挨着它的所有格子。点击每个发光的格子标上 ✕——也可以按住拖动一次标多个！',
      tut_marked: '标得真好！',
